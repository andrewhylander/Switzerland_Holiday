...
const DEFAULT_ITINERARY = [
  ...
  },
  {
    ...
    base: "Grindelwald",
    title: "Grindelwald First + Bort Playground + Village Day",
    location: "Grindelwald",
    tags: ["village", "playground", "cable car"],
    ...
    items: [
      ...
      {
        time: "~9:30 AM",
        title: "Grindelwald First gondola + Cliff Walk",
        location: "Grindelwald Terminal → First",
        notes: "🚶 Walk to Grindelwald Terminal (~10 min from Alpenglück).\n🚠 Firstbahn gondola Terminal → First (~25 min, get off at the top).\n\n🌉 First Cliff Walk — FREE! Walk along steep rock faces and out onto a walkway 45m into the void. Suspension bridge with stunning views of Eiger, Wetterhorn and Schreckhorn.\n\n⏱️ Allow ~30 min for the Cliff Walk.\n\n🏔️ OPTIONAL: Bachalpsee alpine lake walk (1hr each way, easy flat path, 2,265m) — beautiful reflections of the mountains in the lake. Skip if kids are tired — can do another day.",
        tags: ["cable car", "viewpoint"],
      },
      {
        time: "~11:00 AM",
        title: "🛝 Bort Alpine Playground + Mountain Stream",
        location: "Bort (middle gondola station)",
        notes: "Take the gondola back DOWN from First and get off at Bort (middle station, ~15 min down).\n\n🛝 700m² Alpine Playground — one of the best in Switzerland! Giant climbing structures, balance beams, slides, swings, trampolines, sand play, zip line, and rope nets. All with Eiger North Face views.\n\n💦 Mountain stream water play — kids can dam the stream, splash around, redirect the water. Bring spare clothes! Very popular with families.\n\n🐿️ Marmot and squirrel rockers for younger kids.\n\n🎿 Trottibike scooters START from Bort (5km downhill ride to village) — minimum height 125cm so Chloe can't do this. Could be an option for Andrew + Alfie on another day.\n\nFREE — just pay for the gondola ticket.",
        tags: ["playground", "kids"],
      },
      {
        time: "~12:30 PM",
        title: "Lunch at Alpinhotel Bort",
        location: "Bort",
        notes: "🍽️ Restaurant terrace right next to the playground — sit and eat while watching the kids play. Eiger North Face and Wetterhorn views from the terrace.\n\n🧀 Try the local Rösti or Älplermagronen (Swiss Alpine mac and cheese) — classic mountain food.\n\n💡 Or bring a picnic — there are picnic tables and fire pits at Bort too.",
        tags: ["lunch"],
      },
      {
        time: "~2:00 PM",
        title: "Gondola down + Coop grocery shop",
        location: "Bort → Grindelwald Terminal → Coop",
        notes: "🚠 Gondola from Bort back to Grindelwald Terminal (~10 min).\n\n🛒 Coop supermarket is RIGHT at Grindelwald Terminal — perfect for the big weekly shop on the way home. Open 8am–7pm daily including Sunday.\n\n🛒 SHOPPING LIST — Swiss specialties to try:\n• Zopf bread (buttered braided bread — very Swiss)\n• Landjäger sausage sticks (perfect for hiking picnics)\n• Bergkäse / Gruyère mild / Emmental (mountain cheeses — start kids on Emmental or mild Gruyère, similar to cheddar)\n• Birchermüesli (traditional Swiss breakfast cereal)\n• Rivella (Swiss soft drink — must try!)\n• Ovomaltine crunchy spread (like Nutella but Swiss)\n• Ragusa / Toblerone / Lindt chocolate (gifts + treats)\n• Fruit syrups (dilute with sparkling water — great for kids)\n• Fresh fruit cups + salads + sandwich wraps for picnic days\n\n💡 Don't buy bottled water — tap water in Switzerland is excellent and free!\n💡 Look for 'Action' signs = items on sale\n💡 🐞 Ladybug logo = Swiss product\n💡 Bring a bag or put stuff in your backpack — bags cost 5-10 cents\n\n⏱️ Allow 1–1.5 hours for first shop in an unfamiliar store with kids!",
        tags: [],
      },
      {
        time: "~3:30 PM",
        title: "Drop groceries + afternoon options",
        location: "Grindelwald",
        notes: "🚶 Walk groceries back to Alpenglück (~10 min).\n\nAFTERNOON OPTIONS (pick one or just chill!):\n\n🛷 OPTION A — Pfingstegg toboggan + Fly-Line: 15 min walk from Terminal to Pfingstegg valley station. Cable car up (~5 min). Summer toboggan run + Fly-Line zip through the trees. Toboggan: CHF 8/adult, CHF 6/child 8-15, CHF 2/child 6-7. Family total ~CHF 24. Buy tickets individually NOT the Fun Package.\n\n🏔️ OPTION B — Glacier Gorge: 30 min walk from village (or Bus 122). 300m rock faces, spider web net, canyon swing. CHF 19/adult, CHF 10/child, under 6 free. Great rainy day backup too.\n\n🍦 OPTION C — Village wander, ice cream, and chill. You've earned it after a travel day!",
        tags: [],
      },
      {
        time: "EVE",
  ...
  },
  {
    ...
    items: [
      ...
      {
        time: "13:30",
        title: "Glacier Plateau walk + final photos",
        location: "Jungfraujoch",
        notes: "Walk outside on the Aletsch Glacier plateau. Touch the glacier, snowball fight, final family photos at 3,454m.\n\n💡 Don't forget to stamp your passport at the Jungfraujoch post office — the highest post office in Europe!",
        tags: ["snow", "viewpoint"],
      },
      {
        time: "~14:15",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        tags: ["waterfall", "cable car", "history"],
      },
      {
        time: "PM",
  ...
  },
  {
    ...
    tags: ["village", "hike", "waterfall", "viewpoint"],
    ...
    items: [
      ...
      },
      {
        ...
        notes: "⛰️ WENGEN + KLEINE SCHEIDEGG\n🚂 Grindelwald → Lauterbrunnen → Wengen (~40 min). Explore car-free Wengen village — 🛝 playground near the station for the kids. Walk the Wengernalp trail to Kleine Scheidegg (~5km, ~90 min, mostly flat) with Eiger north face views the whole way. Lunch at Restaurant Kleine Scheidegg. Rack railway back (~35 min).\n⏱️ 6–7 hours\n\n🪞 BACHALPSEE ALPINE LAKE\n🚠 Gondola up to Grindelwald First (~20 min). Hike down to Bachalpsee (~3km, ~1.5 hours) — perfect reflections of Wetterhorn & Schreckhorn. Picnic lunch, photo ops, swim if you want. Gondola back down.\n⏱️ 4–5 hours\n\n💧 TRÜMMELBACH FALLS\n10 glacial waterfalls inside a mountain — completely rain-proof and kids LOVE it. Grindelwald → Lauterbrunnen → PostBus to Stechelberg (~20 min). Walk the galleries with waterfalls roaring past (45–60 min, CHF 14/adult).\n⏱️ 4–5 hours",
        tags: ["hike", "viewpoint", "waterfall"],
      },
      {
        time: "🍽️ EVE",
        title: "Final dinner in Grindelwald",
        location: "Grindelwald",
        notes: "Whichever option you choose, return to Grindelwald by early evening.\n\nFinal dinner suggestions:\n• Stallbeizli Heubode — farm restaurant (your favourite)\n• Eiger Bean — cosy local spot\n• Barry's — family-friendly\n\nEarly night — checkout is 9am tomorrow!",
        tags: ["dinner"],
      },
    ],
  },
            ...
            <Card style={{ padding: "14px 16px" }}>
              ...
              <div style={{ display: "grid", gap: 10 }}>
                {[
                  ...
                  { emoji: "🏊", name: "Sportzentrum Grindelwald — Indoor Pool", location: "Dorfstrasse 110, ~15 min walk", time: "2–3 hours", cost: "~CHF 10/adult, CHF 6/child (50% off with Guest Card!)", notes: "Indoor pool with 70m water slide ('Black Hole' with flashing lights), 1m diving board, non-swimmers pool, kids paddling pool. 28°C water. Ropes course and café upstairs. Ask Myriam about the Guest Card!" },
                  ...
                  { emoji: "🍺", name: "Rugenbräu Brewery", location: "Interlaken (~30 min train)", time: "1–2 hours", cost: "~CHF 20–30pp", notes: "Local brewery in Matten bei Interlaken, brewing since 1866. Beer tasting and tour. The Dunkel is excellent. Good paired with an Interlaken wander on a drizzly day." },
