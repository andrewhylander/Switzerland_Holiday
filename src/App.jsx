...
const MAP_PLACES = [
  ...
  { id: "mp34", cat: "restaurant", emoji: "🍴", name: "Restaurant Grindelwaldblick",          location: "Grindelwald",          lat: 46.6252, lng: 8.0424,  mission: "Eat dinner with an Eiger view",              notes: "Panoramic terrace with direct Eiger views. One of the best photo backdrops for dinner in the village. Book terrace tables ahead." },
