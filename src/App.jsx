...
const DEFAULT_ITINERARY = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        notes: "From Interlaken Ost, take the BOB train to Grindelwald (~35 min, runs every 30 min). No changes needed. Scenic rack railway through the valley. Arrive Grindelwald Bahnhof.\n\n⚠️ IMPORTANT: Board on platform 2B in Interlaken Ost. The train physically splits in two at Zweilütschinen — the front half continues to Lauterbrunnen, the back half to Grindelwald. Boarding the wrong half means riding to the wrong valley with tired kids and luggage, so double-check you're in the Grindelwald-bound carriages before you sit down.",
        tags: ["train"],
      },
      {
        time: "Late Evening",
...
const DEFAULT_VENUES = [
  ...
  { id: "v56", name: "Confiserie Rieder",                type: "bakery",     location: "Unterseen",     meals: ["coffee", "breakfast"],                    notes: "Cakes, pastries and chocolate on the walk between Interlaken and Unterseen." },
  { id: "v57", name: "Mohler Bakery",                    type: "bakery",     location: "Unterseen",     meals: ["breakfast", "coffee"],                    notes: "Known for its chocolates, plus baked goods and savoury foods." },
  { id: "v58", name: "Gelateria Azzurra",                type: "cafe",       location: "Interlaken",    meals: ["coffee"],                                  notes: "Gelato stop in Interlaken." },
  // Zurich
...
const MAP_PLACES = [
  ...
  { id: "mp38", cat: "restaurant", emoji: "🔫", name: "Piz Gloria Revolving Restaurant",      location: "Schilthorn",           lat: 46.5582, lng: 7.8342,  rating: 4.5, mission: "Eat in the James Bond revolving restaurant", notes: "007 filming location. Full 360° rotation every ~45 min. 'Schilthorn Brunch' bottomless buffet — 38 CHF/adult, 23 CHF/kid (6–15). Book ahead — tables fill fast in August. Stunning views of 200+ peaks." },
