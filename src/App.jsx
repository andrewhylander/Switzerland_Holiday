...
const DEFAULT_ITINERARY = [
    ...
    items: [
      {
        ...
        notes: "Train from Grindelwald to Lauterbrunnen (~45 min). Arrive and head straight to the valley.",
        tags: ["train", "travel"],
      },
      {
        time: "MID",
      ...
      },
      {
        ...
        notes: "Return bikes, grab an ice cream at Airtime Café, then train back to Grindelwald.",
  ...
  },
  {
    ...
    items: [
      ...
      {
        time: "PM",
        title: "Wengernalp walk + playground",
        location: "Wengen → Wengernalp direction",
        notes: "Easy flat walk along the trail toward Wengernalp with unbeatable Eiger, Mönch & Jungfrau views the whole way. Turn back whenever the kids have had enough. Playground in Wengen for a stop on the way back.",
        tags: ["family", "easy", "hike", "scenic"],
      },
      {
        time: "EVE",
    ...
    items: [
      {
        ...
        notes: "Take the Grindelwald Terminal gondola (~19 min). Modern cabin with huge windows. One of the world's longest gondolas. Aim for an early start to get the clearest views.",
    ...
    items: [
      {
        ...
        notes: "Cable car from Lauterbrunnen to Grütschalp, then the little train to Mürren (~40 min total). Magical car-free cliff village. Visit the Allmendhubel Flower Park playground — water features and themed play with mountain views. Optional: take the cable car up to Schilthorn (Piz Gloria, James Bond revolving restaurant) if energy allows.",
      ...
      },
      {
        ...
        notes: "Relaxed final day. Aare river walk, Höhematte park, ice cream, and souvenir shopping on the Höheweg. Easy afternoon — good if the kids need a gentle last day before travel tomorrow.",
