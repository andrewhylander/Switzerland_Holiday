...
const DEFAULT_ITINERARY = [
  ...
  },
  {
    ...
    base: "Grindelwald",
    title: "Grindelwald Recovery Day: Village Walk + First + Pfingstegg",
    ...
    items: [
      {
        ...
        notes: "• Pop into Co-op supermarket (~15 min) — grab essentials for the week\n• Breakfast at Eiger Bean (local favourite with great views)\n• Get oriented in the village, let the kids burn some energy with an easy walk around the streets\n\n💡 Tip: Ask your Airbnb host to pre-stock basics if you prefer (milk, bread, cheese, coffee)",
        tags: [],
      },
      {
        time: "LATE AM",
        ...
        notes: "• Walk to Grindelwald Terminal: ~10 min\n• Grindelwald Terminal → First: Firstbahn gondola, ~20 min\n• Views of Eiger, Mönch & Jungfrau from the top — perfect orientation for the week ahead",
        tags: ["cable car", "viewpoint"],
      },
      {
        time: "MID",
        title: "First playground + optional Bachalpsee",
        location: "First",
        notes: "Explore the playground at First and enjoy the views.\n\n🏔️ OPTIONAL: Bachalpsee alpine lake walk (3km return) — beautiful reflections of the mountains in the lake, but might be ambitious after travel. Skip it if kids are tired — you can do it another day.",
        tags: ["playground"],
      },
      {
        time: "PM",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        location: "Schilthorn → Birg → Mürren",
        notes: "Cable car down to Mürren (~20 min via Birg). Mürren is one of Switzerland's highest and most scenic car-free villages — no roads, no cars, only mountain trains and footpaths.\n\n🏔️ Eiger, Mönch & Jungfrau fill the entire eastern horizon — one of the most dramatic mountain views in the Alps.\n\n🇨🇭 Walk Mürren's main street — Swiss flags, wooden chalets, flower boxes on every window. Stop at a bakery for a Gipfeli or rösti.\n\n💡 Café Weitblick has a great terrace with direct Eiger views.",
  ...
  },
  {
    ...
    items: [
      ...
      {
        time: "MID",
        title: "Jungfraujoch summit — Top of Europe",
        location: "Jungfraujoch (3,454m)",
        notes: "Visit the Ice Palace (carved tunnels and sculptures inside the glacier), Glacier Plateau (walk on the Aletsch Glacier — largest in the Alps), Sphinx Observation Deck (views to France and Germany on a clear day), and the snow play area outside.\n\n❄️ It will be cold — 0°C to -5°C even in August. Bring warm layers for everyone including the kids.\n\n🛝 Snow play area outside — kids can sledge, throw snowballs and touch the glacier. Unforgettable.",
        tags: ["bucket list", "snow", "viewpoint"],
      },
      {
        time: "PM",
        title: "Optional Kleine Scheidegg stop on return",
        location: "Kleine Scheidegg",
        notes: "Optional stop on the way back down — Kleine Scheidegg is a classic alpine pass with great views of the Eiger North Face.\n\nRestaurant Kleine Scheidegg for a hot drink or lunch. Watch the rack railway arrive and depart — kids love it.",
        tags: ["viewpoint", "train"],
      },
      {
        time: "EVE",
        title: "Return & quiet dinner",
        location: "Grindelwald",
        notes: "Return early — it's been a big altitude day. Quiet dinner in Grindelwald and an early night.\n\n💡 Kids may be tired from the altitude — totally normal. The Sphinx deck is at 3,571m, about 3x higher than Ben Nevis.",
        tags: ["dinner"],
      },
    ],
  },
